    ...
    private fun getSpots() = listOf(
            listOf(
                Spot("우무", "제주 우뭇가사리로 만든 수제 푸딩인데 공항 근처에 있어서 숙소 가기 전에 들렀어요! 전에 왔을 때는 웨이팅이 조금 있었는데 오후 2시쯤에 가니까 사람이 없어서 바로 구매할 수 있었습니다 ㅎㅎ 맛은 커스터드, 초코, 우도땅콩 푸딩 세 개를 구매했는데 다 너무 맛있었어요. 커스터드 맛은 산뜻하고 적당히 단 맛이라면, 초코랑 우도 땅콩 맛은 재료가 많이 들어갔는지 진한 맛이었습니다.\n" +
                    ...
                    "제주특별자치도 제주시 관덕로8길 40-1", 33.5098291165892, 126.523386649277, "차량", "52분"),
                ...
                Spot("공천포식당", "숙소 바로 옆에 식당이 있어서 방문해봤는데 생각 외로 맛있어서 만족스러웠습니다! 전복 물회와 전복죽을 먹었는데 물회는 100% 된장 베이스라 다른 고추장 베이스 물회랑은 또 다른 묘미더라구요. 물회와 죽 모두 전복이 아낌없이 들어가서 너무 좋았습니다.\n" +
                    ...
                    "제주특별자치도 서귀포시 남원읍 공천포로 89", 33.266389016263, 126.64258544722, "도보", "?"),
                Spot("서귀포 매일올레시장", "야식으로 먹을 회포장과 본가로 귤 배달을 시키기 위해 방문했습니다. 유명한 시장이라 그런지 사람들이 많았어요. 저렴하게 회포장하고 가볍게 지인들에게 줄 기성 기념품 구입할 때 방문하는 걸 추천드려요!\n" +
                    ...
                    "제주특별자치도 서귀포시 중앙로62번길 18", 33.2501489768202, 126.563230508718, "", "")
            ), listOf(
                ...
                Spot("천지연폭포", "솔동산고기국수 바로 근처에 천지연폭포가 있어서 산책할 겸 가볍게 걸어서 방문했습니다. 입장료는 만 25세 이상 성인은 2천원, 미만은 1천원인데 데스크나 무인 발권기를 이용해 표를 발권 받을 수 있어요! 관람료도 저렴하고 산책하기 좋은 길이라 밥 먹고 가볍게 방문하기 좋았어요!\n" +
                    ...
                    "제주특별자치도 서귀포시 서홍동 2565", 33.2664146375486, 126.554766074558, "", "")
            ), listOf(
                ...
                Spot("스타벅스 제주 용담 DT점", "비행기 시간까지 얼마 남지 않아서 공항 근처 바다가 보이는 스타벅스를 방문했습니다! 해지는 시간에 방문해서 그런지 창 밖으로 일몰을 감상할 수 있었습니다. 날이 추워 산책하진 않았지만 날이 따뜻할 때 카페 앞 바다에서 산책하는 것도 좋을 것 같아요!\n" +
                    ...
                    "제주특별자치도 제주시 서해안로 380 1층", 33.5123994033523, 126.484509957101, "", "")
            )
        )
