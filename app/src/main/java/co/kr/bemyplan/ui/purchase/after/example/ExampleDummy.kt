    ...
    private fun getSpots() = listOf(
            listOf(
                ...
                Spot("카페서연의집", "영화 ‘건축학개론’에 등장한 촬영 장소인데, 영화를 몰라도 한 번 가보시는 것을 추천해요! 넓은 창문과 그 너머로 바다가 가득 담긴 모습을 보며 힐링하니까 시간 가는 줄 모르겠더라구요. 그리고 본 건물 외에도 승민의 작업실도 있는데 승민의 작업실은 밖이 작게 보이지만 작업실 내의 분위기가 포근하고 안락해서 탁 트인 바다뷰와는 또 다른 매력이 있었어요!\n" +
                    ...
                    "제주특별자치도 서귀포시 남원읍 위미해안로 86", 126.655567630404, 33.2694324178633, "버스", "38분"),
                Spot("솔동산고기국수", "이중섭거리 근처에 있어서 뚜벅이 여행자들도 쉽게 찾아갈 수 있어요. 고기국수와 해물국수 한 개씩 주문했는데 고기국수는 국물이 진하고 고기가 부드러웠습니다. 그리고 해물국수는 해물이 많이 들어서 해물 먼저 먹다가 배가 불러서 국수를 조금 남길 정도였어요 ㅎㅎ 둘이 방문한다면 하나씩 시켜서 같이 먹는 것 추천드려요!\n" +
                    ...
                    "제주특별자치도 서귀포시 부두로 23", 126.565223153339, 33.2429452564123, "도보", "10분"),
                Spot("천지연폭포", "솔동산고기국수 바로 근처에 천지연폭포가 있어서 산책할 겸 가볍게 걸어서 방문했습니다. 입장료는 만 25세 이상 성인은 2천원, 미만은 1천원인데 데스크나 무인 발권기를 이용해 표를 발권 받을 수 있어요! 관람료도 저렴하고 산책하기 좋은 길이라 밥 먹고 가볍게 방문하기 좋았어요!\n" +
                    ...
                    "제주특별자치도 서귀포시 서홍동 2565", 126.554766074558, 33.2664146375486, "", "")
            ), listOf(
                Spot("올레삼다정", "친구가 통갈치구이를 꼭 먹고 싶다고 해서 방문했습니다. 생선구이를 별로 좋아하지 않는 저도 너무 맛있게 잘 먹었어요! 그리고 갈치가 뼈가 많아서 먹기 힘들 수 있는데, 사장님이 큼직하게 손질해주셔서 먹는데 전혀 어렵지 않았습니다. 다음에 또 방문하고 싶을 정도로 밥 도둑이예요 ㅎㅎ\n" +
                    ...
                    "제주특별자치도 서귀포시 태평로537번길 48", 126.569840612818 , 33.2530980764684, "택시", "30분"),
                Spot("바이나흐튼크리스마스박물관", "크리스마스 시즌이 되려면 조금 남았었지만 크리스마스 어드벤트 캘린더를 구매하고 싶어서 겸사겸사 방문했습니다! 박물관이지만 무료로 관람할 수 있고 기부금으로 운영된다고 해요. 12월에는 크리스마스 마켓도 운영된다고 하는데, 제가 방문한 11월에는 아직 마켓 준비중이여서 아쉬웠어요. 호두까기 인형을 비롯해서 다양한 빈티지 제품과 크리스마스 관련 제품들을 구경하고 구매할 수 있어서 흥미로웠습니다. 메인 건물 외에도 옆에 카페와 별관이 있으니 차근차근 둘러보다보면 시간 가는 줄 모를 것 같아요!",
                    ...
                    "제주특별자치도 서귀포시 안덕면 평화로 654", 126.327798877807, 33.2913117398116, "택시", "35분"),
                Spot("스타벅스 제주 용담 DT점", "비행기 시간까지 얼마 남지 않아서 공항 근처 바다가 보이는 스타벅스를 방문했습니다! 해지는 시간에 방문해서 그런지 창 밖으로 일몰을 감상할 수 있었습니다. 날이 추워 산책하진 않았지만 날이 따뜻할 때 카페 앞 바다에서 산책하는 것도 좋을 것 같아요!\n" +
                    ...
                    "제주특별자치도 제주시 서해안로 380 1층", 126.484509957101, 33.5123994033523, "", "")
            )
        )
