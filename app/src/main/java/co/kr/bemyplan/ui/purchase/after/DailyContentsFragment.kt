...
class DailyContentsFragment : Fragment() {
    ...
    private fun initAdapter() {
        ...
        val items = listOf(
            ...
            Spot("난드르바당", "제주특별자치도 서귀포시 안덕면 산방로 141", "https://picsum.photos/300/400/?random", "산방산에서 걸어서 갈 수 있는 카페예요 ! 산방산이 바로 앞에 보이는 뷰와 넓은 내부가 장점입니다. 좌석이 많은데도 사람이 꽤 많아서 그 점은 조금 아쉬웠어요 . 그치만 산방산에 가셨다면 꼭 방문해 보시길 추천드려요 \uD83D\uDE42 간단한 브런치류와 커피, 음료 등이 있어서 취향껏 선택할 수 있어요. \n" +
                    "\n" +
            ...
            Spot("카페 C.hill","제주특별자치도 제주시 애월읍 유수암리 산138", "https://picsum.photos/300/400/?random", "가볍게 오를만한 산이에요. 제가 갔을 때 산방산은 입산이 금지되어 있어서 산방굴사 까지만 오를 수 있었습니다 . 산을 좋아하고 자연을 느끼고 싶은 분들한테 추천드려요 \uD83C\uDF33\n" +
                    "        \\n\\n용머리해안 코스 / 산방굴사 코스가 나뉘어져 있으니 미리 검색해보고 가시면 좋아요. 각각 용머리해안이 보이는 경치 코스와 산방굴사가 있는 코스인데 유료입장이에요. 근데 날씨 영향을 많이 받아서 아쉬워요\uD83D\uDE2D 저희가 갔을때는 날이 흐려서 산방산에서 용머리 해안 경치가 잘 안보여서 산방굴사 코스를 선택할 수 밖에 없었어요 ,, 그리고 산방산 구경 후 용머리해안에 가보고 싶었는데 날씨 문제로 입장이 제한됐어요 .\n" +
                    "        \\n\\n그래서 산방산에 가고싶은 분들은 여행일정 중 맑은날에 가시는걸 추천드려요 ! 마음처럼 되지는 않겠지만 오늘 날씨 진짜 좋은데 ? 싶으면 다음날 일정이랑 체인지를 해서라도 맑은날에 방문하시는게 베스트 일듯 해요",
                "자가용", "한라서적타운", 20, false, false),
            Spot("한라서적타운","제주특별자치도 제주시 애월읍 유수암리 산138", "https://picsum.photos/300/400/?random", "가볍게 오를만한 산이에요. 제가 갔을 때 산방산은 입산이 금지되어 있어서 산방굴사 까지만 오를 수 있었습니다 . 산을 좋아하고 자연을 느끼고 싶은 분들한테 추천드려요 \uD83C\uDF33\n" +
                    "        \\n\\n용머리해안 코스 / 산방굴사 코스가 나뉘어져 있으니 미리 검색해보고 가시면 좋아요. 각각 용머리해안이 보이는 경치 코스와 산방굴사가 있는 코스인데 유료입장이에요. 근데 날씨 영향을 많이 받아서 아쉬워요\uD83D\uDE2D 저희가 갔을때는 날이 흐려서 산방산에서 용머리 해안 경치가 잘 안보여서 산방굴사 코스를 선택할 수 밖에 없었어요 ,, 그리고 산방산 구경 후 용머리해안에 가보고 싶었는데 날씨 문제로 입장이 제한됐어요 .\n" +
                    "        \\n\\n그래서 산방산에 가고싶은 분들은 여행일정 중 맑은날에 가시는걸 추천드려요 ! 마음처럼 되지는 않겠지만 오늘 날씨 진짜 좋은데 ? 싶으면 다음날 일정이랑 체인지를 해서라도 맑은날에 방문하시는게 베스트 일듯 해요",
                "도보", "미친부엌", 10, false, false),
            Spot("미친부엌","제주특별자치도 제주시 애월읍 유수암리 산138", "https://picsum.photos/300/400/?random", "가볍게 오를만한 산이에요. 제가 갔을 때 산방산은 입산이 금지되어 있어서 산방굴사 까지만 오를 수 있었습니다 . 산을 좋아하고 자연을 느끼고 싶은 분들한테 추천드려요 \uD83C\uDF33\n" +
                    "        \\n\\n용머리해안 코스 / 산방굴사 코스가 나뉘어져 있으니 미리 검색해보고 가시면 좋아요. 각각 용머리해안이 보이는 경치 코스와 산방굴사가 있는 코스인데 유료입장이에요. 근데 날씨 영향을 많이 받아서 아쉬워요\uD83D\uDE2D 저희가 갔을때는 날이 흐려서 산방산에서 용머리 해안 경치가 잘 안보여서 산방굴사 코스를 선택할 수 밖에 없었어요 ,, 그리고 산방산 구경 후 용머리해안에 가보고 싶었는데 날씨 문제로 입장이 제한됐어요 .\n" +
                    "        \\n\\n그래서 산방산에 가고싶은 분들은 여행일정 중 맑은날에 가시는걸 추천드려요 ! 마음처럼 되지는 않겠지만 오늘 날씨 진짜 좋은데 ? 싶으면 다음날 일정이랑 체인지를 해서라도 맑은날에 방문하시는게 베스트 일듯 해요",
                null, null, null, false, true)
        )

        contentsAdapter.setItems(items)
